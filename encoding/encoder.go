...
func (e Encoder) encode(iVal interface{}) error {
    ...
    if iVal == nil {
        ...
        case reflect.Ptr:
            val := reflect.TypeOf(iVal)
            err = e.encode(val)
        case reflect.Bool:
            err = e.encodeBool(reflect.ValueOf(iVal).Bool())
        case reflect.Int:
            err = e.encodeInt(reflect.ValueOf(iVal).Int())
        case reflect.Int8:
            err = e.encodeInt(reflect.ValueOf(iVal).Int())
        case reflect.Int16:
            err = e.encodeInt(reflect.ValueOf(iVal).Int())
        ...
        case reflect.Int64:
            err = e.encodeInt(reflect.ValueOf(iVal).Int())
        case reflect.Uint:
            err = e.encodeInt(int64(reflect.ValueOf(iVal).Uint()))
        case reflect.Uint8:
            err = e.encodeInt(int64(reflect.ValueOf(iVal).Uint()))
        case reflect.Uint16:
            err = e.encodeInt(int64(reflect.ValueOf(iVal).Uint()))
        ...
        case reflect.Float32:
            err = e.encodeFloat(reflect.ValueOf(iVal).Float())
        case reflect.Float64:
            err = e.encodeFloat(reflect.ValueOf(iVal).Float())
        case reflect.String:
            err = e.encodeString(reflect.ValueOf(iVal).String())
        case reflect.Slice:
